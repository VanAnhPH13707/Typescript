                    ...
                    <table className="w-full mt-16 whitespace-nowrap">
                        ...
                        <tbody className="w-full text-left">
                            {props.data.map((item, index) => {
                                return <tr className="border-gray-200 border-b">
                                    <th><img className="my-10 pl-4 lg:pl-10 2xl:pl-20 h-20 w-30" src={item.image} alt="shoe" /></th>
                                    <th className="mt-10 text-base font-medium leading-4 text-gray-600 pl-6 lg:pl-20 2xl:pl-52">
                                        <p className="text-base leading-4 text-gray-800 dark:text-white">{item.name}</p>
                                    </th>
                                    ...
                                    <th className="my-10 pl-6 lg:pl-20 2xl:pl-52">
                                        <p className="dark:text-white">{Number(item.price) * Number(item.quantity)}</p>
                                    </th>
                                    <th className="my-10 pl-4 lg:pl-12 2xl:pl-28 pr-4 2xl:pr-20">
                                        <button data-id={item._id} className="btn btn-remove focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-800 text-base leading-none text-red-600 hover:text-red-800"><p>Remove Item</p></button>
                                    </th>
                                </tr>
                            })}
                        </tbody>
