            ...
            <div className="w-full flex items-center justify-center my-12">
                <div className="top-40 bg-white dark:bg-gray-800 shadow rounded py-12 lg:px-28 px-8">
                    ...
                    <div className="flex items-center justify-center w-full">
                        <button className="mt-9 text-base font-semibold leading-none text-white py-3 px-8 bg-amber-400 rounded hover:bg-amber-600 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:outline-none">SUBMIT</button>
                    </div>
                </div>
            </div>
        </div>
