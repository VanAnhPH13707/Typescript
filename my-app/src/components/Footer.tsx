...
const Footer = (props: Props) => {
  return (
    <div className="bg-zinc-900">
      ...
      <div className="2xl:container 2xl:mx-auto xl:px-20 lg:px-12 sm:px-6 px-4 px-4 py-12 ">
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="flex flex-wrap sm:gap-10 gap-8 items-center justify-center mt-8">
            <a href="javascript:void(0)" className="focus:underline focus:outline-none hover:text-gray-500 text-base cursor-pointer leading-4 text-neutral-50 dark:text-gray-400 dark:hover:text-white">About</a>
            <a href="javascript:void(0)" className="focus:underline focus:outline-none hover:text-gray-500 text-base cursor-pointer leading-4 text-neutral-50 dark:text-gray-400 dark:hover:text-white">Contact us</a>
            <a href="javascript:void(0)" className="focus:underline focus:outline-none hover:text-gray-500 text-base cursor-pointer leading-4 text-neutral-50 dark:text-gray-400 dark:hover:text-white">Terms of Service</a>
            <a href="javascript:void(0)" className="focus:underline focus:outline-none hover:text-gray-500 text-base cursor-pointer leading-4 text-neutral-50 dark:text-gray-400 dark:hover:text-white">Privacy Policy</a>
          </div>
          <div className="flex items-center gap-x-8 mt-6">
            <button aria-label="facebook" className="focus:ring-2 focus:ring-offset-2 focus:ring-2 focus:ring-gray-800 focus:outline-none rounded-full">
              <svg className="fill-current text-amber-500 dark:text-white hover:text-amber-600" width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button aria-label="instagram" className="focus:ring-2 focus:ring-offset-2 focus:ring-2 focus:ring-gray-800 focus:outline-none rounded-full">
              <svg className="fill-current text-amber-500 dark:text-white hover:text-amber-600" width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
