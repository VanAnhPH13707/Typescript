                        ...
                        <div className="relative">
                            ...
                            <div className="relative group">
                                ...
                                <div className="absolute bottom-0 p-8 w-full opacity-0 group-hover:opacity-100">
                                    <a href="/products/${product.id}"><button className="dark:bg-gray-800 dark:text-gray-300 font-medium text-base leading-4 text-gray-800 bg-white py-3 w-full">Add to bag</button></a>
