    ...
    <div>
      ...
      <div className=" ">
        <div className="w-full flex bg-zinc-900 justify-around absolute opacity-90 h-14">
          ...
          <div className="flex justify-between">
            <div className="hidden sm:flex flex-row py-3 pl-12 pr-24">
            ...
            <div className="flex justify-center md:block">
              <NavLink className="relative text-gray-700 hover:text-amber-500" to="/cart">
                <svg className="h-8 w-8 mt-3 text-white" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
